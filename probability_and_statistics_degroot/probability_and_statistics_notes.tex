...
\begin{itemize}
    ...
    $P(B|A)$
    \item It essentially tells us how to compute the conditional probability of each event in a
    partition given an observed event $A$.
\end{itemize}
